...
Command: npx gltfjsx@6.2.15 public/models/mech/Mech_FinnTheFrog.gltf -o src/components/mech/Mech_FinnTheFrog.jsx -r public 
*/
...
export function MechFinnTheFrog({
  color = "black",
  animation = "Idle",
  animal = "frog",
  ...props
  ...
  const group = useRef();
  const { scene, materials, animations } = useGLTF('/models/mech/Mech_FinnTheFrog.gltf')
...
useGLTF.preload('/models/mech/Mech_FinnTheFrog.gltf')
