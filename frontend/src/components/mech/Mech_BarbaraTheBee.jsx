...
Command: npx gltfjsx@6.2.15 public/models/mech/Mech_BarbaraTheBee.gltf -o src/components/mech/Mech_BarbaraTheBee.jsx -r public 
*/
...
export function MechBarbaraTheBee({
  color = "black",
  animation = "Idle",
  animal = "bee",
  ...props
  ...
  const group = useRef();
  const { scene, materials, animations } = useGLTF('/models/mech/Mech_BarbaraTheBee.gltf')
...
useGLTF.preload('/models/mech/Mech_BarbaraTheBee.gltf')
