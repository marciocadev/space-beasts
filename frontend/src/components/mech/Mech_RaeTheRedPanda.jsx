...
Command: npx gltfjsx@6.2.15 public/models/mech/Mech_RaeTheRedPanda.gltf -o src/components/mech/Mech_RaeTheRedPanda.jsx -r public 
*/
...
export function MechRaeTheRedPanda({
  color = "black",
  animation = "Idle",
  animal = "redpanda",
  ...props
  ...
  const group = useRef()
  const { scene, materials, animations } = useGLTF('/models/mech/Mech_RaeTheRedPanda.gltf')
...
useGLTF.preload('/models/mech/Mech_RaeTheRedPanda.gltf')
